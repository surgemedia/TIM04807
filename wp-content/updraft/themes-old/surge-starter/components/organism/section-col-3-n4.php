...
<?php
	...
	=            Setup Classes            =
	=====================================*/
	$vars['1_element'][0]['class'] = 'col-md-3'; //because i know this from the file name
	$vars['2_element'][0]['class'] = 'col-md-3'; //because i know this from the file name
	$vars['3_element'][0]['class'] = 'col-md-3'; //because i know this from the file name
	$vars['4_element'][0]['class'] = 'col-md-3'; //because i know this from the file name
